---
title: "Learn Python with the Women in Tech Personality Quiz"
date: 2021-01-25
published: true
topic: "Python"
tags: ["Python", "workshop", "beginner"]
featuredImage: "/assets/introPythonWorkshop/womenInTechPython.png"
---

<img
  src="/assets/introPythonWorkshop//Women in Tech.png"
...
<img
  src="/assets/introPythonWorkshop/concatenate.png"
...
<img
  src="/assets/introPythonWorkshop/output1.png"
  alt="All of the phrases are stuck together"
  style="float: left; margin-right: 90px;"
/>
8. When concatenating strings, you need to manually add the spaces. Change the `fullSentance`
to include the following spaces. ``` fullSentence = firstProgram + " " + intro +
" " + myName + ". " + i + " " + strInt + " " + years + "." ```
<img
  src="/assets/introPythonWorkshop/output2.png"
...
<img
  src="/assets/introPythonWorkshop/popup1.png"
  alt="Pop up example"
  style="float: left; margin-right: 90px;"
/>
