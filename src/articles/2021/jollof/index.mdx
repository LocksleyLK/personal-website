...
We have reached the final week of the [Seasons of Serverless](https://github.com/microsoft/Seasons-of-Serverless) challenge where we are travelling to Africa to create a recipe hotline for jollof rice.
...
I first created a Twilio trial account. This involved creating a project, verifying my phone number, and accessing the string identifier (SID) and authorization token. This is what connects my Azure Function to a phone number to send and recieve messages.
...
1. The Jollof Recipe. This calue vontains the ingredients and instructions to make authentic jollof. This is what will be texted to a user.
