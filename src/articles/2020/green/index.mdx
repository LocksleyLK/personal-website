...
As technologists, we spend a lot of time behind desktop computers, laptops, and our mobile phones. Although it isn't obvious, these actions have an imapct on the environment. In this article, we'll talk about sustainable software engineering, and the steps you can take to become more eco-friendly.
...
In a typical compute resource, you have to provision enough servers to accomodate the peak number of isers. This means that when your service load is light, you are paying for and consuming resources that aren't being used.

In comparison, serverless resources are **event-driven**. This means that your resources are only run when triggered. Although serverless architecture is not the solution for all of your resources, it can be used in specific circumstances to reduce resource consumption, save energy, and decrease carbon emissions.
...
Even if you can't use serverless, you can still make changes with your computer habits to lower your annual carbon emissions. Here are some suggestions:
...
If everyone adopted these habits, this would prevent unenecessary carbon emissions.
